      ...
      if (idx === messages.length - 1 && m.role === "user") {
        return {
          ...
          content: [
            ...
            { type: "file" as const, data: fileBuffer, mimeType: "application/pdf" },
          ],
        };
      }
      return {
